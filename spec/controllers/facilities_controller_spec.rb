  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved facility as @facility" do
        ...
        post :create, {:facility => { "title" => "invalid value" }}, valid_session
        assigns(:facility).should be_a_new(Facility)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested facility" do
        ...
        Facility.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => facility.to_param, :facility => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the facility as @facility" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Facility.any_instance.stub(:save).and_return(false)
        put :update, {:id => facility.to_param, :facility => { "title" => "invalid value" }}, valid_session
        assigns(:facility).should eq(facility)
      end
